  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-bold text-brand-soft-blue mb-4">
          Blog Kategorileri
        </h1>
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {[...Array(8)].map((_, index) => (
            <div key={index} className="bg-white border border-brand-light-blue rounded-lg p-6 animate-pulse">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {categories.map((category: BlogCategory, index) => (
            ...
            >
              <div className="bg-white border border-brand-light-blue rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300 group-hover:border-gray-300">
