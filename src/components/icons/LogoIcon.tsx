...
type Props = {
  className?: string;
  /** If provided, sets inline CSS color; otherwise inherits current text color. */
  color?: string;
  /** Width/height. If string, passed to both width and height. */
  size?: number | string;
  /** Optional title for accessibility. */
  title?: string;
  /** When true, marks the SVG as decorative. Defaults to true. */
  ariaHidden?: boolean;
};

export default function LogoIcon({ className, color, size, title, ariaHidden = true }: Props) {
  const sizeProps =
    typeof size === 'number'
